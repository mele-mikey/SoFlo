...
export const api = {
  ...
  saveCourseCalendarManualItem: (input: { id?: string; classId: string; title: string; dueDate: string; startTime?: string | null; description?: string | null; color: string }) => call<CourseCalendarDetail>('save_course_calendar_manual_item', { input }),
  archiveCourseCalendarManualItem: (id: string) => call<void>('archive_course_calendar_manual_item', { id }),
  ...
  createSetWithCards: (input: { classId: string; title: string; description?: string; cards: { front: string; back: string; notes?: string | null; imagePath?: string | null; position: number; isStarred: boolean }[] }) => call<FlashcardSetDetail>('create_flashcard_set_with_cards', { input }),
  ...
  exportDocumentDocx: (input: { title: string; content: string; contentPlain: string }) => call<string>('export_document_docx', { input }),
  ...
  prepareAiForSession: (generalModelPath: string, voiceModelPath: string, mode: 'writing' | 'study') => call<void>('prepare_ai_for_session', { generalModelPath, voiceModelPath, mode }),
