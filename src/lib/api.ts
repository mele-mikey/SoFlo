...
export const api = {
  ...
  generateFlashcardsText: (modelPath: string, materials: string, guidance: string, syllabusContext = '', maxCards = 100) => call<string>('generate_flashcards_text', { modelPath, materials, guidance, syllabusContext, maxCards }),
