...
function App() {
  ...
  const researchAndGrade = async (text: string) => {
    const aiModelPath = await ensureAiModel()
    ...
    try { return await api.researchAndGradeText(aiModelPath, text) } finally { setAiProgress(null) }
  }
