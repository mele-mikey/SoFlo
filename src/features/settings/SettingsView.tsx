...
export function SettingsView({ settings, dataLocation, security, onSettingsChange, onSecurityChange, onToast, onStartWalkthrough }: SettingsViewProps) {
  ...
  return <main className="settings-view content-view">
    ...
    <section className="settings-section">
      ...
      <SettingRow title="Spellcheck" detail="Use the browser's simple spelling checks as you write. AI spellcheck adds an extra review when enabled."><Toggle checked={settings.spellcheck} onChange={(spellcheck) => void update({ spellcheck })} /></SettingRow>
    ...
    <section className="settings-section about-section">
      <SectionHeading icon={<Info size={18} />} title="About SoFlo" detail="Version 1.0.70" />
